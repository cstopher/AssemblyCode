...
POLL2  LDAB PORTA ;load value from port a
       JSR DEL
       ANDB  #$01 ;masks lcb
       BEQ    POLL2;branch while pushbutton is not pushed
POLL3  LDAB PORTA ;load value from port a;
       BITB #$01  ;masks lcb but does not store it
       BNE POLL3  ;when button is pushed branch
       LDAB PORTE
       STAB $0001
POLL4  LDAB PORTA ;load value from port a
       JSR DEL
       ANDB  #$01 ;masks lcb
       BEQ    POLL4;branch while pushbutton is not pushed
    
POLL5  LDAB PORTA ;load value from port a;
       BITB #$01  ;masks lcb but does not store it
       BNE POLL5  ;when button is pushed branch
       LDAB PORTE
       STAB $0002
POLL6  LDAB PORTA ;load value from port a
       JSR DEL
       ANDB  #$01 ;masks lcb
       BEQ    POLL6;branch while pushbutton is not pushed
     
POLL7  LDAB PORTA ;load value from port a;
       BITB #$01  ;masks lcb but does not store it
       BNE POLL7  ;when button is pushed branch
       LDAB PORTE
       STAB $0003
       ...
       JSR TONE
DTONE  JSR TONE
POLL8  LDAB PORTA ;load value from port a
       JSR DEL
       ANDB  #$01 ;masks lcb
       BEQ    POLL8;branch while pushbutton is not pushed
 
POLL9  LDAB PORTA ;load value from port a;
       BITB #$01  ;masks lcb but does not store it
       BNE POLL9  ;when button is pushed branch
       LDAA $0010
       ADDA $0010
       DAA
       LDAB $0017
...
;SUBROUTINE for delay between ouputs
DEL    LDX #$5000
DELAY3 DEX
       NOP
       BNE DELAY3
